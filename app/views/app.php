...
<head>
    ...
    <title>Admin | JL Photographia</title>
    <!-- Bootstrap core CSS -->
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <li><a href="<?php echo $config->base_url('admin'); ?>"><i class="fa fa-home"></i> Home</a></li>
                <li><a href="<?php echo $config->base_url('admin/clients'); ?>"><i class="fa fa-users"></i> My Clients</a></li>
                <li><a href="<?php echo $config->base_url('admin/selected'); ?>"><i class="fa fa-file-photo-o"></i> Selected Photos</a></li>
                <li><a href="<?php echo $config->base_url('admin/gallery'); ?>"><i class="fa fa-photo"></i> Gallery</a></li>
                <li class="dropdown">
